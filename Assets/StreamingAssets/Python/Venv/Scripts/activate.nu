...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\My Games\NeoForge\Assets\StreamingAssets\Python\Venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\My Games\NeoForge\Assets\StreamingAssets\Python\Venv\Scripts\deactivate.nu'
